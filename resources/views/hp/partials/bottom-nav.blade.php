<nav class="fixed bottom-0 inset-x-0 z-[200] glass-panel-mobile border-t pb-safe bg-white/90 dark:bg-background-dark/95 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
