...
<div class="space-y-8">
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-6" data-purpose="stats-overview">
        ...
        <div class="content-card rounded-xl p-6 flex flex-col justify-between h-48">
            ...
            <div>
                ...
                <div class="inline-flex items-center px-2 py-1 bg-blue-50 border border-blue-100 rounded">
                    ...
                    <span class="text-[9px] font-bold text-corp-accent uppercase tracking-wider">Status Member {{ $user->role->name ?? 'Member' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="content-card rounded-xl p-6 flex flex-col justify-between h-48">
            ...
            <div>
                <div class="text-2xl font-bold text-corp-navy mb-3 uppercase tracking-tight">{{ $user->role->name ?? 'Member' }}</div>
