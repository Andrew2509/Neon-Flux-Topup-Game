...
<div class="min-h-[80vh] flex flex-col items-center justify-center px-4 pt-32 pb-20 relative overflow-hidden">
    <!-- Background Decor -->
    <div class="pointer-events-none absolute top-1/4 -left-20 size-96 bg-primary/10 blur-[120px] rounded-full animate-pulse" aria-hidden="true"></div>
    <div class="pointer-events-none absolute bottom-1/4 -right-20 size-80 bg-cyan-500/10 blur-[120px] rounded-full animate-pulse" style="animation-delay: 2s" aria-hidden="true"></div>
