...
<nav class="fixed bottom-0 inset-x-0 z-[480] lg:hidden border-t border-white/10 bg-[#0a0a15]/95 backdrop-blur-xl shadow-[0_-8px_32px_rgba(0,0,0,0.4)] pb-[max(0.35rem,env(safe-area-inset-bottom))]" aria-label="Menu utama">
