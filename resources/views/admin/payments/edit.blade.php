...
@section('page_title', 'Edit Metode')
@section('page_description', 'Perbarui detail dan biaya metode pembayaran.')
                    ...
                    <div class="space-y-4">
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="name" required placeholder="Contoh: BCA Transfer" value="{{ old('name', $payment->name) }}"
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="code" required placeholder="Contoh: BCA" value="{{ old('code', $payment->code) }}"
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="type" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all appearance-none cursor-pointer">
                                <option value="bank" {{ old('type', $payment->type) == 'bank' ? 'selected' : '' }}>Bank Transfer</option>
                                <option value="ewallet" {{ old('type', $payment->type) == 'ewallet' ? 'selected' : '' }}>E-Wallet / VA</option>
                                <option value="qris" {{ old('type', $payment->type) == 'qris' ? 'selected' : '' }}>QRIS</option>
                                <option value="retail" {{ old('type', $payment->type) == 'retail' ? 'selected' : '' }}>Retail Outlet (Alfamart/Indomaret)</option>
                            </select>
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="provider" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all appearance-none cursor-pointer">
                                <option value="Duitku" {{ old('provider', $payment->provider) == 'Duitku' ? 'selected' : '' }}>Duitku</option>
                                <option value="iPaymu" {{ old('provider', $payment->provider) == 'iPaymu' ? 'selected' : '' }}>iPaymu</option>
                            </select>
                    ...
                    <div class="space-y-4">
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <input type="number" name="fee" required placeholder="0" value="{{ old('fee', $payment->fee) }}" min="0" step="0.01"
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="account_number" placeholder="Contoh: 1234567890 a/n Prince" value="{{ old('account_number', $payment->account_number) }}"
                                    class="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-4 py-3 text-sm focus:ring-1 focus:ring-accent-blue focus:border-accent-blue outline-none transition-all font-mono">
                            </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="status" required class="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all appearance-none cursor-pointer">
                                ...
                                <option value="Nonaktif" {{ old('status', $payment->status) == 'Nonaktif' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
