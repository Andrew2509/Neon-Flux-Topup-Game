...
@section('page_title', 'Buat Voucher Baru')
@section('page_description', 'Tambahkan kode diskon atau promo baru untuk pengguna.')
                    ...
                    <div class="space-y-4">
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="code" required placeholder="Contoh: PROMOAWALYTAHUN" value="{{ old('code') }}"
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="relative group">
                                ...
                                <input type="number" name="min_purchase" required placeholder="50000" value="{{ old('min_purchase') }}"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="number" name="quota" required placeholder="100" value="{{ old('quota') }}"
                                        class="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-4 py-3 text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all font-mono">
                                </div>
